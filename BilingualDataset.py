...
class BilingualDataset(Dataset):
    ...
    def __init__(self, dataset, sourceTokenizer, targetTokenizer, sourceLang, targetLang, sequenceLen)->None:
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        decoderPaddingTokensNum = self.sequenceLen - len(decoderInputTokens) - 1 # no need ot EOS
        ...
        return {
            ...
            'decoderMask': (decoderInput != self.padToken) & causalMask(decoderInput.size(0)),
            'label': label,
