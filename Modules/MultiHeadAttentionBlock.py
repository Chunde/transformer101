...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        assert (
            self.d_model % h == 0
        ), "dimension of embedding should be divisible by number of headers h"
    ...
    def forward(self, q, k, v, mask):
        ...
        # Q: tensor view -1 means?
        # A: he actual value for this dimension will be inferred so that 
        #    the number of elements in the view matches the original number of elements.
